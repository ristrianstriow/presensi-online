<x-app-layout title="Ubah Lokasi Presensi">
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h1 class="text-2xl font-bold text-slate-900 tracking-tight">Ubah Lokasi: {{ $lokasi->nama_lokasi }}</h1>
                <p class="text-sm text-slate-500 mt-0.5">Perbarui titik koordinat GPS kantor, batas radius, dan ketentuan jam kerja.</p>
            </div>
        </div>
    </x-slot>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="bg-white rounded-xl border border-slate-200 shadow-xs p-6 space-y-4">
                ...
                <div>
                    ...
                    <input type="text" id="nama_lokasi" name="nama_lokasi" value="{{ old('nama_lokasi', $lokasi->nama_lokasi) }}" required
                ...
                <div>
                    ...
                    <textarea id="alamat_lokasi" name="alamat_lokasi" rows="2" required
                              class="mt-1 block w-full py-2 px-3 text-sm border border-slate-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">{{ old('alamat_lokasi', $lokasi->alamat_lokasi) }}</textarea>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" id="tipe_lokasi" name="tipe_lokasi" value="{{ old('tipe_lokasi', $lokasi->tipe_lokasi) }}" required
                               class="mt-1 block w-full py-2 px-3 text-sm border border-slate-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                    ...
                    <div>
                        ...
                        <input type="number" id="radius" name="radius" value="{{ old('radius', $lokasi->radius) }}" required min="5" max="10000"
                               class="mt-1 block w-full py-2 px-3 text-sm border border-slate-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" id="latitude" name="latitude" value="{{ old('latitude', $lokasi->latitude) }}" required
                    ...
                    <div>
                        ...
                        <input type="text" id="longitude" name="longitude" value="{{ old('longitude', $lokasi->longitude) }}" required
                               class="mt-1 block w-full py-2 px-3 text-sm font-mono border border-slate-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                ...
                <div class="grid grid-cols-3 gap-4">
                    <div>
                        ...
                        <select id="zona_waktu" name="zona_waktu" required
                            ...
                            <option value="WIB" {{ old('zona_waktu', $lokasi->zona_waktu) === 'WIB' ? 'selected' : '' }}>WIB (UTC+7)</option>
                            <option value="WITA" {{ old('zona_waktu', $lokasi->zona_waktu) === 'WITA' ? 'selected' : '' }}>WITA (UTC+8)</option>
                            <option value="WIT" {{ old('zona_waktu', $lokasi->zona_waktu) === 'WIT' ? 'selected' : '' }}>WIT (UTC+9)</option>
                        </select>
                    ...
                    <div>
                        ...
                        <input type="time" id="jam_masuk" name="jam_masuk" value="{{ old('jam_masuk', substr($lokasi->jam_masuk, 0, 5)) }}" required
                               class="mt-1 block w-full py-2 px-3 text-sm border border-slate-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                    ...
                    <div>
                        ...
                        <input type="time" id="jam_pulang" name="jam_pulang" value="{{ old('jam_pulang', substr($lokasi->jam_pulang, 0, 5)) }}" required
                               class="mt-1 block w-full py-2 px-3 text-sm border border-slate-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
            ...
            <div class="bg-white rounded-xl border border-slate-200 shadow-xs p-6 flex flex-col space-y-3">
                <div class="flex items-center justify-between pb-3 border-b border-slate-200">
                    ...
                    <span class="text-xs text-slate-400">Klik atau geser penanda</span>
                </div>
